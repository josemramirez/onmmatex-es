...
const NonMemoizedMarkdown = ({
  ...
  const components = {
    ...
    root: ({
      children
    }: any) => <div className="prose prose-zinc dark:prose-invert max-w-none text-sm">
        {children}
      </div>,
    ...
    code: ({
      ...
      return !inline && match ? <pre {...props} className="
            relative
            text-sm
            w-full
            overflow-x-auto
    ...
    table: ({
      ...
      return <div className="w-full overflow-x-auto mb-4">
          <table className="
              min-w-full
              border-collapse
              text-sm
