...
import { BrainCircuitIcon, FileSearchIcon, Loader2Icon, PlayIcon, SearchIcon, SparklesIcon } from 'lucide-react';
...
export function ResearchProgress({
  ...
  return <div ref={containerRef} onScroll={handleScroll} className="h-full w-full overflow-y-auto no-scrollbar px-3 py-2 md:px-4 md:py-3 space-y-2">
          ...
          ease: [0.4, 0, 0.2, 1]
              ...
              <div className={`
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {details.length > 0 && <p className="mt-2 text-xs text-muted-foreground/70 line-clamp-2">
                      {details.join('\n')}
                    </p>}

                  {step.queries && <div className="mt-2.5 space-y-2">
